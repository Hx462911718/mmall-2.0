...
/**
 * @author:hexin
 * @ctrateTime:2018年05月11日 9:35:00
 */
...
public class OrderServiceImpl implements IOrderService {
    ...
    @Override
    public void insertProductByOrder(int days) {
        Date currentDate = DateUtils.addDays(new Date(),-days);
        List<Order> orderList =  orderMapper.selectOrderByStatusAndCreateTime(Const.OrderStatusEnum.NO_PAY.getCode(),currentDate);
        for(Order order:orderList){
            ...
            for (OrderItem orderItem : orderItemList){
                ...
                product1.setId(9999);
                product1.setName("路大汉");
                product1.setCategoryId(100011);
                product1.setPrice(new BigDecimal("111"));
                product1.setStock(10);
                product1.setDetail(order.getId().toString());
